...
class RadioTelescopeUI(QtWidgets.QWidget):
    ...
    def setup_connections(self):
        ...
        self.horizontalSlider.valueChanged.connect(self.on_integration_time_changed)
...
class RadioTelescope1420(gr.top_block):
    ...
    def __init__(self, ui):
        ...
        # 频谱显示
        self.spectrum_display_block = spectrum_display_block.SpectrumDisplayBlock(vec_length=vec_length, parent=ui)
        # widget.setParent(self.spectrum_widget)
        # self.spectrum_widget.layout().addWidget(widget)
        # widget.show()
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.spectrum_integration_block.samp_rate = self.samp_rate/4
