...
class untitled.py(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "untitled.py")
        ...
        self.samp_rate_0 = samp_rate_0 = 6000000
        ...
        self._yzoom_range = qtgui.Range(1, 10000, 1, 10, 5)
        ...
        for c in range(10, 16):
            self.gui_tab_grid_layout_0.setColumnStretch(c, 1)
        self._yroll_range = qtgui.Range(-1000, 1000, 0.01*yzoom, 0, 5)
        self._yroll_win = qtgui.RangeWidget(self._yroll_range, self.set_yroll, "roll", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*vec_length, './123', True)
...
def main(top_block_cls=untitled.py, options=None):
